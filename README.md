...
- **Tools:** 4 specialized tools for group discovery and context retrieval
- **Prompts:** 4 multilingual prompt templates for common meal planning scenarios

### Meal Planning Features
- Multi‑profile contextual meal recommendations
- Strict enforcement of allergies, restrictions, dislikes
